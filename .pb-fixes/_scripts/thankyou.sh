...
*** Developers & Scripts ***:\n
Rpc80 (Ryan Connors), Rydra, EasyHax (aka Forrest), Demetris Ierokipides aka Ntemis, CyperGhost, Meleu, Lars Muldjord (Skyskraper), David Marti (Motion Blue), Bezel Project Team, Folly, Valerino, Aditya Shakya aka adi1090x, Paul Cercueil aka pcercuei, MS Copilot.\n\n

*** OS & FrontEnd ***:\n
Armbian Team for the nice clean OS!.\n
Retropie Team (Retropie), Andrew Mickelson (Attract Mode) & Radek Dutkiewicz aka oomek (Attract Mode Plus), HyperPie Team (HyperPie), Mátyás Mustoha (Pegasus-FE).\n\n
